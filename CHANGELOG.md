...
- Split monolithic theme.js into modular files under modules/ using theme.js as a barrel export
- Update mobile menu overlay to fill space below the logo and burger nav bar
- Add tap-to-zoom image lightbox & enhanced publications page
- Slim down README, added DEVELOPMENT.md
- Made post rows fully clickable while keeping tag chips independently active
- Add hooks for terminal animation and implement featured/latest post logic
